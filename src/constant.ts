import {BilldHtmlWebpackPluginLog, MediaTypeEnum} from './api/live/interface';
import {prodDomain} from './api/live/spec-config';
...
export const appBuildInfo =
    ...
    {
        version: '0.0.1',
        buildTime: '2023-03-22 15:00:00',
        commitId: '1234567890',
        commitMsg: 'test',
        commitAuthor: 'billd',
        commitDate: '2023-03-22 15:00:00',
        commitUrl: 'https://github.com/galaxy-s10/billd-live-flutter/commit/1234567890',
        buildUrl: 'https://github.com/galaxy-s10/billd-live-flutter/commit/1234567890',
        buildBranch: 'master',
        buildEnv: 'development',
        buildHost: 'localhost:4300',
        lastBuildDate: '2023-03-22 15:00:00',
    }
export const WEBSOCKET_URL =
    import.meta.env.VITE_APP_NODE_ENV === 'development'
        ? `ws://localhost:8070`// `ws://localhost:4300`
...
export const THEME_COLOR = '#121211';
