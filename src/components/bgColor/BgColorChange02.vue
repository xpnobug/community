  ...
  <div class="main-newchat" :themes="currentTheme" :class="{ dark: isDarkMode }">
    <div class="app-container">
      <button class="mode-switch" @click="toggleDarkMode">
        ...
        <svg class="moon" fill="none" stroke="#5c67ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"  viewBox="0 0 24 24"><defs/><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/></svg>
      </button>
    </div>
  </div>
</template>
