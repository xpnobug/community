    ...
    <div class="grid centered"
      ...
      <div class="user-preview" v-for="item in userChannelList" :class="[{'small' : viewIdValueSet === '2'}]">
        <div class="user-preview"
          ...
          <div class="user-preview-info" style="padding-bottom: 32px;">
<!--            <div class="tag-sticker"><svg class="tag-sticker-icon icon-public">-->
<!--              <use xlink:href="#svg-public"></use>-->
<!--            </svg></div>-->
            <div class="user-short-description" style="padding-top: 60px;">
              <div class="xm-header user-avatar user-short-description-avatar"
                   :style="[{width: addWidth + 'px', height: addHeight + 'px'} ,' border: none; cursor: pointer; border-radius: 6px;']">
                <div class="xm-avatar"
                     :style="[{width: avatarWidth + 'px', height: avatarHeight + 'px'},'padding:6px']">
                  <img :src="item.logo" alt="头像" class="" style="border-radius: 12px;"></div>
              </div>
            ...
            <div class="user-stats" :class="{'small-user-stats': viewIdValueSet === '3'}" style="margin-top: 30px;">
              ...
              <div class="user-stat">
                <p class="user-stat-title">{{ item.memberCount }}</p>
                <p class="user-stat-text">成员</p>
              </div>
              <div class="user-stat">
                <p class="user-stat-title">{{ item.essenceCount }}</p>
...
onBeforeMount(() => {
  avatarWidth.value = '110';
  avatarHeight.value = '110';
...
const setAvatarSize = (size:any) => {
  ...
  switch (size) {
    case '1':
      ...
      break;
    case '2':
      avatarWidth.value = '80';
      avatarHeight.value = '80';
      addWh(avatarWidth.value, avatarHeight.value)
      break;
    case '3':
      avatarWidth.value = '50';
      avatarHeight.value = '50';
      addWh(avatarWidth.value, avatarHeight.value)
      break;
    default:
      avatarWidth.value = '110';
