...
const props = defineProps(['summary','createTime'])
  ...
  <div class="grid-column fixed" style="top: -639px;">
    <div class="widget-box">
      ...
      <div class="widget-box-text">
        <p class="paragraph-box"><span class="paragraph-title">创建日期</span><span class="paragraph-text">{{ timeUtils.convertTime(createTime) }}</span></p>
      </div>
    </div>
    <div class="widget-box">
      <p class="widget-box-title">成员 （999+）</p>
      <div class="widget-box-content">
        <div class="filters">
          <p class="filter"
