...
const addPost = () => {
  ...
  console.log(formState.publishPlatform)
  if (formState.publishPlatform === undefined && type.value === "tz") {
    message.error("请选择发布版块");
    return
  }
                ...
                <a-form :model="formState" autocomplete="off" name="basic" @finish="onFinish"
                  ...
                  <div class="content-item thread" style="" v-if="type === 'tz'">
                    <div class="form-row form-post-title">
                      <a-form-item :rules="[{ required: true, message: '标题不能为空!' }]"
                                   name="title">
                        ...
                        <div class="form-row" style="margin-left: 0px;">
                          <div class="form-item">
                            <div class="form-textarea">
                              <a-textarea v-model:value="formState.content" :maxlength="500"
                                          :rows="4"
                                          placeholder="请输入"/>
                            </div>
                          </div>
                  ...
                  <div class="set-up">
                    ...
                    <div class="more-set-box" style="padding-bottom: 0px;" v-if="type !== 'dt'">
                      <div class="more-item new-release">
                        <div class="title">
                          ...
                          <!--                            </svg>-->
                          <!--                          </div>-->
                          <div> 发布版块 <p class="explain">
                            选择内容发布的目标版块，支持选择版块和分类</p>
                          </div>
                        </div>
                    ...
                    <div class="more-set-box" style="padding-bottom: 0px;" v-if="type !== 'dt'">
                      <div class="more-item new-release">
                        ...
                        <button class="select-forum-btn ant-btn" type="button"><span>请选择</span>
                        </button>
                        <!--                        <CascaderCom/>-->
                      </div>
                    </div>
                    <div class="more-set-box" style="padding-bottom: 0px;" v-if="type !== 'dt'">
                      <div class="more-item new-release">
                        ...
                        <button class="select-forum-btn ant-btn" type="button">
                          <span>请选择联系人</span></button>
                      </div>
                    </div>
                    <div class="more-set-box" style="padding-bottom: 0px;" v-if="type !== 'dt'">
                      <div class="more-item new-release">
                        ...
                        <button class="select-forum-btn ant-btn" type="button"><span>上传附件</span>
                        </button>
                        <input id="file" alt="" class="upload" name="input" style="display: none;"
                               type="file">
                      </div>
                    ...
                    <div class="more-set-box" is-forum="0">
                      <div class="more-item">
                        <div class="title">
                          <div class="set-icon"><i aria-label="icon: security-scan"
                            ...
                            <svg aria-hidden="true" class="" data-icon="security-scan"
                                 fill="currentColor"
                        ...
                        <div class="text ant-dropdown-trigger">
                          <button class="ant-btn" style="margin-left: 8px;" type="button"><span>所有人可见</span><i
                            ...
                            <svg aria-hidden="true" class="" data-icon="down" fill="currentColor"
                                 focusable="false"
                                 height="1em" viewBox="64 64 896 896" width="1em">
                              <path
                                  d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path>
                      ...
                      <div class="more-item">
                        <div style="display: flex;">
                          <div class="title">
                            <div class="set-icon"><i aria-label="icon: bell"
                                                     class="icon anticon anticon-bell">
                              <svg aria-hidden="true" class="" data-icon="bell" fill="currentColor"
                                   focusable="false"
                                   height="1em" viewBox="64 64 896 896" width="1em">
                                <path
                            ...
                            <div> 消息推送 <p class="explain">
                              有访问权限的用户将会收到该内容的推送消息</p>
                            </div>
                          </div>
                        </div>
                        <div>
                      ...
                      <div class="more-item">
                        <div class="title">
                          <div class="set-icon"><i aria-label="icon: stop"
                                                   class="icon anticon anticon-stop">
                            <svg aria-hidden="true" class="" data-icon="stop" fill="currentColor"
                                 focusable="false"
                                 height="1em" viewBox="64 64 896 896" width="1em">
                              <path
                      ...
                      <div class="more-item">
                        <div class="title">
                          <div class="set-icon"><i aria-label="icon: eye-invisible"
                            ...
                            <svg aria-hidden="true" class="" data-icon="eye-invisible"
                                 fill="currentColor"
                                 focusable="false" height="1em" viewBox="64 64 896 896" width="1em">
                              <path
                      ...
                      <div class="more-item">
                        <div class="title">
                          <div class="set-icon"><i aria-label="icon: transaction"
                            ...
                            <svg aria-hidden="true" class="" data-icon="transaction"
                                 fill="currentColor"
                                 focusable="false" height="1em" viewBox="64 64 896 896" width="1em">
                              <path
                      ...
                      <div class="more-item">
                        <div class="title">
                          <div class="set-icon"><i aria-label="icon: dollar"
                                                   class="icon anticon anticon-dollar">
                            <svg aria-hidden="true" class="" data-icon="dollar" fill="currentColor"
                                 focusable="false"
                                 height="1em" viewBox="64 64 896 896" width="1em">
                              <path
                        ...
                        <div>
                          <button class="ant-switch" role="switch" type="button"><span
