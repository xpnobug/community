...
<template>
  <div class="grid-column snipcss-iJ4SG">
    ...
    <!--    <div class="widget-box no-padding" video-height="0" v-for="item in postList">-->
    ...
    <!--            </div>-->
    <!--            <p class="user-status-title medium"><span class="bold" style="cursor: pointer; color: rgb(251, 91, 90);">{{ item.author }}</span> </p>-->
    ...
    <div v-for="item in postList" class="widget-box no-padding" video-height="0">
      <div class="widget-box-settings" style="z-index: 100;">
        <div class="post-settings-wrap" style="display: none;">
          <div style="position: relative;">
            <div>
      ...
      <div class="widget-box-status">
        <div class="widget-box-status-content">
          <div class="user-status" style="position: relative;">
            <div class="xm-header user-avatar"
              ...
              <div class="xm-avatar" style="width: 44px; height: 44px; padding: 6.4px;"><img :src=item.avatar alt="头像"
                                                                                             class=""
        ...
        <div class="post-preview medium" style="margin: 16px 28px 0px;">
          ...
          <div class="post-preview-info with-cover" style="margin-top: 0px;">
            ...
            <div><a class="post-preview-link" href="/post/6194" target="_blank">
