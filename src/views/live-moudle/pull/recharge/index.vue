...
import { fetchFindByTypeGoods } from '@/api/live/goods';
import QrPayCpt from '@/views/live-moudle/compontents/QrPay/index.vue';
import { GoodsTypeEnum } from '@/api/live/interface';
...
async function startPay() {
  if (money.value < minMoney) {
    message.warning(`最少充值${minMoney}元！`);
    return;
  }
  ...
  if (res.data.code === 200) {
    ...
    nextTick(() => {
      ...
      goodsInfo.goodsId = res.data.data.id!;
