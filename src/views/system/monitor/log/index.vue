...
<div class="content-grid">
  <div class="content-view">
    <div class="table-page">
      <arco-row justify="space-between" align="center" class="header">
        <arco-space wrap>
      ...
      <arco-tabs v-model:active-key="activeKey" type="card-gutter" size="large" @change="change">
        <arco-tab-pane key="1" title="登录日志" />
        <arco-tab-pane key="2" title="操作日志" />
      </arco-tabs>
      <keep-alive>
